...
- pin_list:
  ...
  - {pin_num: '54', peripheral: LPSPI0, signal: 'pcs, 0', pin_signal: PTB0, direction: INPUT/OUTPUT}
  - {pin_num: '53', peripheral: LPSPI0, signal: sout, pin_signal: PTB1, direction: INPUT/OUTPUT}
  - {pin_num: '48', peripheral: LPSPI0, signal: 'sck, sck', pin_signal: PTB2, direction: INPUT/OUTPUT}
  - {pin_num: '46', peripheral: ADC0, signal: 'se, 12', pin_signal: PTC14}
  - {pin_num: '36', peripheral: FTM2, signal: 'ch, 0', pin_signal: PTD10, direction: OUTPUT}
